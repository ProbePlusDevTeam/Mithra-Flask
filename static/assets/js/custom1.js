...
function enableEditList(name) {
  ...
  var act_img = document.getElementsByClassName("act_img_id")
  var full_act_img = document.getElementsByClassName("act_full_img_id")
  
  for (var i=0 ; i<act_img.length; i++){
    console.log(act_img[i].id)
    let c = x.id

      if (!c.localeCompare(act_img[i].id) && x.style.display === "block") {
        console.log("if")
        console.log(act_img[i].id)
        x.style.display = "none";
        ...
        console.log("else")
        console.log(act_img[i].id)
        let o = document.getElementById(act_img[i].id)
        let r = document.getElementById(full_act_img[i].id)
...
function UpdateQuestion() {
  ...
  //var section = document.querySelector(".question-section:checked").value
  console.log(section)
  var question_sectionName = document.getElementById("question-sectionName").value
  var question_sectionNameKannada = document.getElementById("question-sectionNameKannada").value
  ...
  if(q_num == ""){
    document.getElementById("editQnumError").innerText = "Required"
    err1 = true
  }

  // else if(numbers.test(parseInt(q_num))){
  //   document.getElementById("editQnumError").innerText = "Required"
  //   err1 = true
  // }
  else if (parseInt(q_num) < 1 || parseInt(q_num) > 999) {
  ...
  if (!err1 && !err2 && !err3) {
    ...
    var udatedQuestionData = [{
      ...
      "kan_ques": kan_ques,
      "section": section,
      "question_sectionName_e": question_sectionName,
      "question_sectionName_k": question_sectionNameKannada,
      "type": type,
...
function AddQuestion() {
  ...
  var question_sectionNameKannada = "";
  ...
  if (document.getElementById("question-sectionNameKannada").value == "") {
    question_sectionNameKannada = "null"
  }
  else {
    question_sectionNameKannada = document.getElementById("question-sectionNameKannada").value
  }
  ...
  // else if(numbers.test(parseInt(question_number))){
  //   document.getElementById("qNumLimitError").innerText = "Invalid"
  //   document.getElementById("qNumError").innerText = ""
  //   err = true
  // }
  else if (parseInt(question_number) < 0 || parseInt(question_number) >= 999) {
    document.getElementById("qNumLimitError").innerText = "Invalid, 1 - 999 only"
    document.getElementById("qNumError").innerText = ""
    err = true
  }
  else {
  ...
  if (!err && !error1 && !error2 && !error3 && !error4 && !error5 && !error6 && !error7 && !error8) {
    ...
    var questionData = [{
      ...
      "section_name_e": question_sectionName,
      "section_name_k": question_sectionNameKannada,
      "opttype": type,
      "opt": "opt",
      "opt_e": quesEnData,
      "opt_k": quesKaData,
...
function addDevice() {
  ...
  if (macAddress == "") {
    ...
    document.getElementById("macAddrssError").innerText = "Device ID must be 3 digits"
    err = true
  }
  else {
...
function editDevice() {
  ...
  else if(editManual_id.length != 3){
    document.getElementById("editManualIdError").innerText = "Must be 3 characters only"
    err = true
  }
  else {
...
function upModuleMapping() {
  ...
  if (!err1 && !err2 && !err3 && !err4 && !err5) {
    ...
    console.log(updateModuleMappingData)
    $.ajax({
      type: "PUT",
